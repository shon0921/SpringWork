...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/main/inquiry/inquiryEditInfo").setViewName("forward:/html/main/inquiry/EditInfo.html");
        ...
        registry.addViewController("/main/notice/noticeEditInfo").setViewName("forward:/html/main/notice/noticeInfo.html");
